...
summary: "This is an experiment to see how this page is going to be generated, and to get a feel for using this theme to build my website."
sidebar: mydoc_sidebar
permalink: mydoc_experiment.html
folder: mydoc
---

# My name is Callan Whitney. This is the first experiment.

## The beginning of the experiment
It's funny that I feel like I'm doing something wrong by deleting the existing text in this file, when it's completely fine because it's just a copy of an existing file. Anyway, hopefully this should be visible
